...
// Modify the ZombieFactory contract to inherit from Ownable. 
// Again, you can take a look at zombiefeeding.sol if you don't remember how this is done.

pragma solidity >=0.5.0 <0.6.0;
import "./ownable.sol"; // This line of code was added
contract ZombieFactory is Ownable { // This line of code was edited
